...
ActiveRecord::Schema[7.1].define(version: 2024_07_27_161826) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "brazilian_cup_champions", force: :cascade do |t|
  ...
  create_table "club_foundations", force: :cascade do |t|
    t.string "club_key"
